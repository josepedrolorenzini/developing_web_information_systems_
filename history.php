...
if(isset($_POST['emp_num'])){
    ...
    if($employee->getEmployee() > 0){
        header('Location: ./view_history.php?emp_num='.$employee->emp_num);
        exit;
    }
    else{
...
<main class="container">
    ...
    <?php 
        ...
        $icon_page  = '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
